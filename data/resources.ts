...
export const resources: Resource[] = [
  ...
  // },
    ...
    modeLabel: ["ONLINE COURSE","WEBINAR"],
    title: "Quantum Quest",
    description: "Discover Pasqal's approach to quantum computing through their interactive learning platform. They have built Quantum Quest to suit your needs, fitting for beginners and experts alike. 5 modules: 1) Introduction 2) Mathematics 3) Physics 4) Optimization 5) Machine Learning",
    audiences: ["Beginner","Intermediate"],
    certificate: "No",
    provider: "Pasqal",
  ...
  // },
    ...
    description: "Quest is a quantum dictionary, a free resource database where you can find key concepts of Quantum Physics. Each entry of the Quantum Dictionary is tackled by Qplaylearn's unique methodology relying on three different approaches to learning: games, videos, and graphics are used to form intuition, simple yet accurate explanations to understand physics, and mathematics to formalise your knowledge.",
    audiences: ["Beginner"],
    certificate: "No",
    provider: "Qplaylearn",
    ...
    modeLabel: ["GAME"],
    title: "2Qubit Dance",
    description: "Inspired by interactive console dance games and the movements of Bloch's mathematical model of the sphere, the 2Qubit Dance game lets each participant become a set of 2 qubits. For the duration of a song, follow the characters to make your arms move in the manner of a Bloch sphere, following the quantum logic gates seen on the screen.",
    audiences: ["Beginner"],
    certificate: "No",
    provider: "Institut Quantique - University of Sherbrooke",
    url: "https://www.youtube.com/playlist?list=PLtn704u3JW-IRjl_4ynGyYFr1NjlkhWHk",
    language:["English","French"],
    target:["Beginner"],
    prerequisite:["None"],
    format:["Educational Toolkits"]
    ...
    modeLabel: ["GAME"],
    title: "Hello Quantum ",
    description: "Explore the building blocks of quantum mechanics in a series of puzzles. You'll be learning key behaviors in the mysterious world of quantum mechanics to progress forward.",
    audiences: ["Beginner"],
    certificate: "No",
    provider: "IBM",
    url: "https://quantum.cloud.ibm.com/composer?initial=N4IgjghgzgtiBcIDyAFAogOQIoEEDKAsgAQBMAdAAwDcAOgHYCWdAxgDYCuAJgKZE3jdWDAEYBGMk2b9ademABO3AOZEwAbQAsAXRnNFK5pp316IADQg6EGNwQgAqnQAuDJ626cizBvObtXIAC%2BQA",
    language:["English"],
    target:["Beginner"],
    prerequisite:["None"],
    format:["Educational Toolkits"]
    ...
    description: "Discover the art of quantum algorithm design with ‘Quantum Odyssey,’ an award-winning, all-visual quantum computing simulator. This intuitive platform takes you from the basics to advanced concepts, making learning accessible and engaging through stunning visual, interactive simulations. Ideal for enthusiasts and professionals alike, it demystifies quantum computing and offers a full hands-on experience throughout the learning process.",
    audiences: ["Beginner"],
    certificate: "No",
    provider: "QURECA",
    url: "https://lms.qureca.com/product/quantum-odyssey/?v=d88fc6edf21e",
    language:["English"],
    target:["Beginner"],
    prerequisite:["None"],
    format:["Educational Toolkits"]
